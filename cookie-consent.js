(function () {
  ...
  function injectStyles() {
    ...
    style.textContent = [
      ...
      '.imd-cookie-text p{margin:0 0 9px}',
      '.imd-cookie-text p:last-child{margin-bottom:0}',
      '.imd-cookie-text strong{color:#fff;font-weight:750}',
      ...
      '.imd-cookie-btn-save{grid-column:1}',
      '.imd-cookie-btn-reject{grid-column:2}',
      ...
      '.imd-cookie-btn-confirming{background:#28b95b!important;color:#102314!important;border-color:#28b95b!important;box-shadow:0 0 0 3px rgba(40,185,91,.20)!important}',
  ...
  function renderBanner(forceOpen) {
    ...
    layer.innerHTML = [
      ...
      '<div><div class="imd-cookie-kicker">Datenschutz</div><h2 class="imd-cookie-title" id="imd-cookie-title">Einwilligung zu Cookies &amp; Datenverarbeitung</h2></div>',
      '</div>',
      '<div class="imd-cookie-text"><p>Mit der Auswahl <strong>Alle akzeptieren</strong> stimmen Sie der Nutzung optionaler Dienste auf unserer Website zu. Dadurch k&ouml;nnen externe Schriftarten und Karteninhalte geladen werden.</p><p>Notwendige Funktionen sichern den Betrieb der Website, Formulare und die Datenschutzauswahl. Diese sind immer aktiv.</p><p>Sie k&ouml;nnen Ihre Auswahl jederzeit &uuml;ber <strong>Cookie-Einstellungen</strong> im Footer &auml;ndern oder widerrufen.</p></div>',
      '<div class="imd-cookie-options" id="imdCookieOptions"></div>',
      '<div class="imd-cookie-actions">',
      '<button class="imd-cookie-btn imd-cookie-btn-primary" type="button" data-cookie-action="accept">Alle akzeptieren</button>',
      '<button class="imd-cookie-btn imd-cookie-btn-save" type="button" data-cookie-action="save">Auswahl speichern</button>',
      '<button class="imd-cookie-btn imd-cookie-btn-reject" type="button" data-cookie-action="reject">Nur notwendige</button>',
      '</div>',
      '</div>',
      '</div>'
    ].join('');
    ...
    layer.addEventListener('click', function (event) {
      ...
      if (action === 'save') {
        event.target.classList.add('imd-cookie-btn-confirming');
