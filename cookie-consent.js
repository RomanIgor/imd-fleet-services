(function () {
  ...
  function injectStyles() {
    ...
    style.textContent = [
      ...
      '@media(max-width:760px){.imd-cookie-layer{inset:auto 12px 12px;justify-content:center}.imd-cookie-box{width:100%;border-radius:22px;background:linear-gradient(145deg,rgba(255,255,255,.88),rgba(200,216,232,.36));box-shadow:0 22px 60px rgba(9,21,42,.28)}.imd-cookie-inner{border-radius:21px;background:linear-gradient(145deg,rgba(248,250,252,.96),rgba(226,232,240,.92));color:#111827}.imd-cookie-inner::before{background:linear-gradient(90deg,transparent,rgba(255,255,255,.95),transparent)}.imd-cookie-head{padding:15px 15px 10px}.imd-cookie-mark{background:#fff;border-color:rgba(15,23,42,.10);box-shadow:0 10px 24px rgba(9,21,42,.08)}.imd-cookie-mark svg{color:#1a2540}.imd-cookie-kicker{color:#64748b}.imd-cookie-title{color:#111827}.imd-cookie-text{padding:0 15px 12px;color:#475569}.imd-cookie-options{grid-template-columns:1fr;gap:7px;padding:0 15px 13px}.imd-cookie-option{min-height:0;display:grid;grid-template-columns:1fr auto;gap:10px;align-items:center;background:rgba(255,255,255,.72);border-color:rgba(15,23,42,.10)}.imd-cookie-option strong{color:#111827}.imd-cookie-option span{color:#64748b}.imd-cookie-toggle{align-self:center;background:rgba(15,23,42,.08);border-color:rgba(15,23,42,.16)}.imd-cookie-toggle::after{background:#fff;box-shadow:0 2px 5px rgba(9,21,42,.18)}.imd-cookie-toggle[aria-checked="true"]{background:#1a2540;border-color:#1a2540}.imd-cookie-toggle[aria-checked="true"]::after{background:#fff}.imd-cookie-actions{padding:13px 15px 15px;border-top-color:rgba(15,23,42,.08);background:rgba(255,255,255,.45)}.imd-cookie-btn{height:39px;color:#1a2540;background:rgba(255,255,255,.72);border-color:rgba(15,23,42,.12)}.imd-cookie-btn-primary{background:#1a2540;color:#fff;border-color:#1a2540}.imd-cookie-manage{left:12px;bottom:12px;background:rgba(248,250,252,.88);color:#1a2540;border-color:rgba(15,23,42,.12)}}'
    ].join('');
