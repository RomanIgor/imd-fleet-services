(function () {
  ...
  function injectStyles() {
    ...
    style.textContent = [
      ...
      '.imd-cookie-box{width:min(620px,100%);padding:1px;border-radius:24px;background:linear-gradient(145deg,rgba(150,150,146,.46),rgba(92,92,88,.32));box-shadow:0 26px 90px rgba(20,20,18,.42);pointer-events:auto;animation:imdCookieIn .42s cubic-bezier(.22,1,.36,1)}',
