(function () {
  ...
  function injectStyles() {
    ...
    style.textContent = [
      ...
      '@media(max-width:760px){.imd-cookie-layer{inset:auto 14px 14px;justify-content:center}.imd-cookie-box{width:min(420px,100%);border-radius:20px;background:linear-gradient(145deg,rgba(226,232,240,.72),rgba(148,163,184,.30));box-shadow:0 18px 46px rgba(9,21,42,.24)}.imd-cookie-inner{border-radius:19px;background:linear-gradient(145deg,rgba(226,232,240,.94),rgba(203,213,225,.88));color:#111827}.imd-cookie-inner::before{background:linear-gradient(90deg,transparent,rgba(255,255,255,.72),transparent)}.imd-cookie-head{grid-template-columns:34px 1fr;gap:10px;padding:13px 13px 8px}.imd-cookie-mark{width:34px;height:34px;border-radius:11px;background:rgba(255,255,255,.54);border-color:rgba(15,23,42,.10);box-shadow:0 8px 18px rgba(9,21,42,.07)}.imd-cookie-mark svg{width:17px;height:17px;color:#263241}.imd-cookie-kicker{font-size:8px;color:#64748b}.imd-cookie-title{font-size:16px;color:#111827}.imd-cookie-text{padding:0 13px 10px;font-size:11.5px;line-height:1.48;color:#475569}.imd-cookie-options{grid-template-columns:1fr;gap:6px;padding:0 13px 11px}.imd-cookie-option{min-height:0;display:grid;grid-template-columns:1fr auto;gap:9px;align-items:center;padding:9px 10px;border-radius:13px;background:rgba(241,245,249,.68);border-color:rgba(15,23,42,.09)}.imd-cookie-option strong{font-size:10.5px;color:#111827}.imd-cookie-option span{font-size:10px;line-height:1.28;color:#64748b}.imd-cookie-toggle{align-self:center;width:36px;height:20px;background:rgba(15,23,42,.08);border-color:rgba(15,23,42,.16)}.imd-cookie-toggle::after{width:12px;height:12px;background:#fff;box-shadow:0 2px 5px rgba(9,21,42,.18)}.imd-cookie-toggle[aria-checked="true"]{background:#334155;border-color:#334155}.imd-cookie-toggle[aria-checked="true"]::after{left:19px;background:#fff}.imd-cookie-actions{padding:11px 13px 13px;border-top-color:rgba(15,23,42,.08);background:rgba(203,213,225,.34)}.imd-cookie-btn{height:36px;border-radius:10px;font-size:10.5px;color:#1f2937;background:rgba(241,245,249,.70);border-color:rgba(15,23,42,.10)}.imd-cookie-btn-primary{background:#334155;color:#fff;border-color:#334155}.imd-cookie-manage{left:12px;bottom:12px;background:rgba(226,232,240,.86);color:#334155;border-color:rgba(15,23,42,.12)}}'
    ].join('');
