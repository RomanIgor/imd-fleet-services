(function () {
  ...
  function injectStyles() {
    ...
    style.textContent = [
      ...
      '.imd-cookie-layer{position:fixed;inset:18px 24px auto;z-index:2147483000;display:flex;justify-content:center;pointer-events:none}',
      '.imd-cookie-box{width:min(720px,100%);padding:1px;border-radius:24px;background:linear-gradient(145deg,rgba(150,150,146,.46),rgba(92,92,88,.32));box-shadow:0 22px 70px rgba(20,20,18,.34);pointer-events:auto;animation:imdCookieIn .42s cubic-bezier(.22,1,.36,1)}',
      ...
      '.imd-cookie-option{position:relative;display:flex;min-width:0;min-height:92px;flex-direction:column;justify-content:space-between;padding:11px;border:1px solid rgba(255,255,255,.12);border-radius:16px;background:rgba(255,255,255,.075)}',
      ...
      '.imd-cookie-toggle{align-self:flex-start;width:38px;height:22px;border:1px solid rgba(255,255,255,.17);border-radius:999px;background:rgba(30,30,28,.20);position:relative;cursor:pointer;transition:.18s}',
