...
function toggleMob(){const m=document.getElementById('mobMenu'),b=document.getElementById('burger'),bd=document.getElementById('mobBackdrop');m.classList.toggle('open');if(bd)bd.classList.toggle('open');const isOpen=m.classList.contains('open');b.classList.remove('is-open','is-closed');b.classList.add(isOpen?'is-open':'is-closed');document.body.style.overflow=isOpen?'hidden':'';}
function closeMob(){document.getElementById('mobMenu').classList.remove('open');const b=document.getElementById('burger');b.classList.remove('is-open');b.classList.add('is-closed');const bd=document.getElementById('mobBackdrop');if(bd)bd.classList.remove('open');document.body.style.overflow='';}
function goTo(id){document.getElementById(id).scrollIntoView({behavior:'smooth'});}


// ─── MODELL DROPDOWN ───
const MODELLE = {
  'Alfa Romeo': ['Giulia','Giulia Quadrifoglio','Stelvio','Stelvio Quadrifoglio','Tonale','Tonale Plug-in Hybrid'],
  'BYD': ['Atto 3','Seal','Seal U','Han','Tang','Dolphin','Seagull','Sealion 6','Sealion 7'],
  'Genesis': ['G70','G80','G80 Electrified','G90','GV70','GV70 Electrified','GV80'],
  'Audi': ['A1 Sportback','A3 Sportback','A3 Limousine','A3 Allstreet','A4 Limousine','A4 Avant','A4 Allroad','A5 Sportback','A5 Cabriolet','A6 Limousine','A6 Avant','A6 Allroad','A7 Sportback','A8','Q2','Q3','Q3 Sportback','Q4 e-tron','Q4 Sportback e-tron','Q5','Q5 Sportback','Q7','Q8','Q8 e-tron','Q8 Sportback e-tron','e-tron GT','RS e-tron GT','TT','R8'],
  'BMW': ['1er (118i / 118d / 120d)','2er Active Tourer','2er Gran Coupé','2er Coupé','2er Cabriolet','3er Limousine','3er Touring','4er Coupé','4er Gran Coupé','4er Cabriolet','5er Limousine','5er Touring','6er Gran Turismo','7er','8er Gran Coupé','X1','X2','X3','X4','X5','X6','X7','iX1','iX3','iX','i4','i5','i5 Touring','i7','M2','M3','M3 Touring','M4','M5','Z4'],
  'Citroën': ['C3','ë-C3','C3 Aircross','C4','ë-C4','C5 X','C5 Aircross','Berlingo','SpaceTourer','ë-SpaceTourer','Jumpy','ë-Jumpy','Relay'],
  'Cupra': ['Born','Formentor','Formentor e-Hybrid','Leon','Leon Sportstourer','Ateca','Terramar'],
  'Dacia': ['Sandero','Sandero Stepway','Logan','Duster','Jogger','Spring Electric','Bigster'],
  'DS Automobiles': ['DS 3','DS 3 E-Tense','DS 4','DS 4 E-Tense','DS 7','DS 7 E-Tense','DS 9','DS 9 E-Tense'],
  'Fiat': ['Panda','Panda Hybrid','500','500e','500X','Tipo','Tipo Kombi','Doblo','Ducato'],
  'Ford': ['Fiesta','Focus','Focus Turnier','Focus Active','Kuga','Kuga PHEV','Puma','Puma Mild Hybrid','Mustang Mach-E','Explorer Electric','Galaxy','S-Max','Transit Custom','Transit Custom PHEV','Transit','Tourneo Custom','Tourneo Connect'],
  'Honda': ['Jazz','Jazz Crosstar e:HEV','Civic e:HEV','HR-V e:HEV','ZR-V e:HEV','CR-V e:HEV','CR-V e:PHEV','e:Ny1'],
  'Hyundai': ['i10','i20','i20 N','i30','i30 N','i30 Fastback','Elantra','Tucson','Tucson Plug-in Hybrid','Santa Fe','Santa Fe Plug-in Hybrid','Kona','Kona Electric','IONIQ 5','IONIQ 5 N','IONIQ 6','IONIQ 9','Staria'],
  'Jaguar': ['E-Pace','F-Pace','F-Pace SVR','F-Type','I-Pace','XE','XF','XF Sportbrake','XJ'],
  'Jeep': ['Avenger','Avenger Electric','Renegade','Renegade 4xe','Compass','Compass 4xe','Wrangler','Wrangler 4xe','Grand Cherokee','Grand Cherokee 4xe'],
  'Kia': ['Picanto','Stonic','Rio','Ceed','Ceed Sportswagon','XCeed','ProCeed','Sportage','Sportage Plug-in Hybrid','Sorento','Sorento Plug-in Hybrid','Niro HEV','Niro Plug-in Hybrid','Niro EV','EV6','EV6 GT','EV9','Stinger'],
  ...
  'Lexus': ['UX 250h','UX 300e','NX 250h','NX 350h','NX 450h+','RX 350h','RX 500h','RZ 450e','IS 300h','ES 300h','LS 500h','LC 500h'],
  'Mazda': ['Mazda2','Mazda3','Mazda3 Fastback','Mazda6','CX-3','CX-30','CX-5','CX-60','CX-80','MX-30','MX-30 R-EV','MX-5'],
  'Mercedes-Benz': ['A-Klasse','A-Klasse Limousine','B-Klasse','C-Klasse Limousine','C-Klasse T-Modell','CLA','CLA Shooting Brake','CLS','E-Klasse Limousine','E-Klasse T-Modell','E-Klasse All-Terrain','S-Klasse','GLA','GLB','GLC','GLC Coupé','GLE','GLS','EQA','EQB','EQC','EQE','EQE SUV','EQS','EQS SUV','AMG GT 4-Türer','Sprinter','Vito','eSprinter','V-Klasse','EQV'],
  'MG': ['MG3','MG3 Hybrid+','MG4 Electric','MG5 Electric','MG ZS','MG ZS EV','MG HS','MG HS Plug-in Hybrid','Cyberster'],
  'MINI': ['Mini 3-Türer','Mini 5-Türer','Mini Cabrio','Mini Clubman','Mini Countryman','Mini Countryman Electric','Mini Cooper SE','Mini Aceman','Mini Pacesetter'],
  'Mitsubishi': ['Space Star','Colt','Eclipse Cross','Eclipse Cross Plug-in Hybrid','Outlander','Outlander Plug-in Hybrid','ASX','ASX Plug-in Hybrid'],
  'Nissan': ['Micra','Juke','Juke Hybrid','Qashqai','Qashqai e-Power','X-Trail','X-Trail e-Power','Leaf','Ariya','Navara','Townstar Electric'],
  'Opel': ['Corsa','Corsa Electric','Astra','Astra Sports Tourer','Astra Electric','Astra Hybrid','Insignia','Insignia Sports Tourer','Crossland','Mokka','Mokka Electric','Grandland','Grandland PHEV','Vivaro','Vivaro Electric','Zafira Life','Combo','Movano'],
  'Peugeot': ['208','e-208','2008','e-2008','308','308 SW','408','3008','3008 PHEV','5008','e-5008','Partner','Rifter','e-Rifter','Expert','e-Expert','Traveller','e-Traveller','Boxer'],
  'Polestar': ['Polestar 2','Polestar 3','Polestar 4'],
  'Porsche': ['Macan','Macan Electric','Cayenne','Cayenne E-Hybrid','Cayenne Turbo E-Hybrid','Cayenne Coupé','Panamera','Panamera 4 E-Hybrid','Panamera Turbo E-Hybrid','Panamera Sport Turismo','Taycan','Taycan 4S','Taycan GTS','Taycan Turbo','Taycan Cross Turismo','911 Carrera','911 Targa','911 GT3','718 Boxster','718 Cayman'],
  'Renault': ['Clio','Clio E-Tech Hybrid','Mégane E-Tech Hybrid','Mégane E-Tech Electric','Captur','Captur E-Tech Plug-in','Koleos','Arkana E-Tech Hybrid','Austral E-Tech Hybrid','Scenic E-Tech Electric','Espace E-Tech Hybrid','Zoe','Kangoo','Kangoo E-Tech Electric','Trafic','Master'],
  'Seat': ['Ibiza','Leon','Leon Sportstourer','Leon e-Hybrid','Arona','Ateca','Tarraco','Mii electric'],
  'Skoda': ['Fabia','Scala','Octavia','Octavia Combi','Octavia RS','Superb','Superb Combi','Superb iV','Kamiq','Karoq','Kodiaq','Enyaq iV','Enyaq Coupé iV','Elroq'],
  'Smart': ['#1','#1 Brabus','#3','#3 Brabus'],
  'Subaru': ['Impreza','Levorg','Legacy Outback','Forester','XV','Solterra'],
  'Suzuki': ['Swift','Swift Sport','Baleno','Vitara','Vitara Hybrid','S-Cross','S-Cross Hybrid','Ignis','Across Plug-in Hybrid','Swace Hybrid'],
  'Tesla': ['Model 3','Model 3 Long Range','Model 3 Performance','Model Y','Model Y Long Range','Model Y Performance','Model S','Model S Plaid','Model X','Model X Plaid','Cybertruck'],
  'Toyota': ['Yaris','Yaris Cross','GR Yaris','Corolla Limousine','Corolla Touring Sports','C-HR','C-HR Plug-in Hybrid','RAV4 Hybrid','RAV4 Plug-in Hybrid','Highlander Hybrid','Land Cruiser','bZ4X','Proace','Proace Verso','Proace City','Proace City Verso','Proace Electric','Camry Hybrid'],
  'Volkswagen': ['Polo','Golf','Golf Variant','Golf GTI','Golf GTE','Golf R','Passat Limousine','Passat Variant','Arteon','Arteon Shooting Brake','T-Cross','T-Roc','T-Roc Cabriolet','Tiguan','Tiguan Allspace','Touareg','Touran','ID.3','ID.4','ID.4 GTX','ID.5','ID.5 GTX','ID.7','ID.7 Tourer','ID. Buzz','Caddy','Caddy Maxi','Transporter T6.1','Transporter T7','Multivan T7','California','Crafter'],
  'Volvo': ['V60','V60 Cross Country','V60 Recharge','V90','V90 Cross Country','V90 Recharge','S60','S60 Recharge','S90','S90 Recharge','XC40','XC40 Recharge','XC60','XC60 Recharge','XC90','XC90 Recharge','C40 Recharge','EX30','EX40','EX90'],
  'Andere': [],
};
