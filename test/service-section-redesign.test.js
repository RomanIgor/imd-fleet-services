...
test('service wide desktop protects the showroom logo with compact rails', () => {
  ...
  assert.match(wideDesktopCss, /#service\{(?=[^}]*background-size:cover,cover,cover,min\(100vw,1920px\) auto)(?=[^}]*background-position:center center,center center,center center,center -300px)[^}]*\}/s);
  assert.doesNotMatch(wideDesktopCss, /background-position:[^}]*center calc\(/s);
